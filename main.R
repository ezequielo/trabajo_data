...
#Distribuci贸n de la acidez fija
grid.arrange(ggplot(wine, aes( x = 1, y = fixed.acidity ) ) + geom_jitter(alpha = 0.1 ) +
             ...
             ncol = 2, top="Distribuci贸n de los valores de acidez fija")

#Distribuci贸n de la acidez volatil
grid.arrange(ggplot(wine, aes( x = 1, y = volatile.acidity ) ) + geom_jitter(alpha = 0.1 ) +
             ...
             ncol = 2, top="Distribuci贸n de los valores de acidez vol谩til")

#Distribuci贸n del 谩cido c铆trico
grid.arrange(ggplot(wine, aes( x = 1, y = citric.acid ) ) + geom_jitter(alpha = 0.1 ) +
             ...
             ncol = 2, top="Distribuci贸n de los valores del 谩cido c铆trico")

#Distribuci贸n del azucar residual
imagen = grid.arrange(ggplot(wine, aes( x = 1, y = residual.sugar ) ) + geom_jitter(alpha = 0.1 ) +
             ...
             ncol = 2, top="Distribuci贸n de los valores del az煤car residual")

#Distribuci贸n de los cloruros
grid.arrange(ggplot(wine, aes( x = 1, y = chlorides ) ) + geom_jitter(alpha = 0.1 ) +
             ...
             ncol = 2, top="Distribuci贸n de los valores de cloruros")

#Distribuci贸n del di贸xido de azufre libre
grid.arrange(ggplot(wine, aes( x = 1, y = free.sulfur.dioxide )) + geom_jitter(alpha = 0.1 ) +
             ...
             top="Distribuci贸n de los valores de di贸xido de azufre libre")

#Distribuci贸n del di贸xido de azufre total
grid.arrange(ggplot(wine, aes( x = 1, y = total.sulfur.dioxide )) + 
             ...
             top="Distribuci贸n de los valores de di贸xido de azufre total")

#Distribuci贸n de la densidad
grid.arrange(ggplot(wine, aes( x = 1, y = density)) + geom_jitter(alpha = 0.1 ) +
             ...
             top="Distribuci贸n de los valores de la densidad")
...
grid.arrange(ggplot(wine, aes( x = 1, y = pH)) + geom_jitter(alpha = 0.1 ) +
            ...
            top="Distribuci贸n de los valores de pH")

#Distribuci贸n de sulfatos
grid.arrange(ggplot(wine, aes( x = 1, y = sulphates)) + geom_jitter(alpha = 0.1 ) +
             ...
             scale_x_continuous(lim = c(0.3,1.6)), ncol = 2, top="Distribuci贸n de los valores de sulfatos")

#Distribuci贸n de alcohol
grid.arrange(ggplot(wine, aes( x = 1, y = alcohol)) + geom_jitter(alpha = 0.1 ) + 
             ...
             scale_x_continuous(lim = c(8,14)), ncol = 2, top="Distribuci贸n de los valores de alcohol")
